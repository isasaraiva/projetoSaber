...
export const HeroSection = (): JSX.Element => {
  return (
    <section className="relative w-full bg-[#0346c8] py-16 px-8 overflow-hidden">
      <div className="relative max-w-[1440px] mx-auto min-h-[862px]">
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          <div className="flex flex-col ">
            <h1 className="[font-family:'Paytone_One',Helvetica] p-20 font-normal text-[#d5f48c] text-[49px] tracking-[1.50px] leading-[56px] max-w-[683px]">
              O Sesi Ceará Tem A Alegria De Lançar O Projeto
            </h1>
            ...
            <p className="[font-family:'Libre_Franklin',Helvetica] p-20 font-normal text-[#c5b3ff] text-[32px] tracking-[0] pt-20 leading-[normal] max-w-[900px]">
